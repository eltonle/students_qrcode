            ...
            <div class="row">
                <section class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('etudiants.store') }}" method="POST" id="myForm">
                                @csrf
                                <div class="form-row">
                                    {{-- nom --}}
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            class="@error('name') is-invalid @enderror" placeholder="Nom etudiant">
                                        @error('name')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="prenom" class="form-control"
                                            class="@error('prenom') is-invalid @enderror" placeholder="prenom etudiant">
                                        @error('prenom')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            class="@error('email') is-invalid @enderror" placeholder="email etudiant">
                                        @error('email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="phone" class="form-control"
                                            class="@error('phone') is-invalid @enderror" placeholder="phone etudiant">
                                        {{-- @error('phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror --}}
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="formation_id" id="formation" class="form-control">
                                            <option value="">veuillez renseigner une formation</option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="section_id" id="section" class="form-control">
                                            <option value="">veuillez renseigner une section</option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="mention_id" id="mention" class="form-control">
                                            <option value="">veuillez renseigner une mention</option>
