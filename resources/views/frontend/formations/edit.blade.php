            ...
            <div class="row">
                <section class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('formation.update',$edit_formation->id) }}" method="POST"
                                id="myForm">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="mat_code" class="form-control"
                                            ...
                                            value="{{ $edit_formation->mat_code }}">
                                        @error('mat_code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6" style="">
                                        <input type="submit" class="btn btn-success" value="modifier les donnees">
